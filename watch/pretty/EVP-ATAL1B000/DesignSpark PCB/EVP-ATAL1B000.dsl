...
(library Library_1
	...
	(patternDef "EVPATAL1B000" (originalName "EVPATAL1B000")
		...
		(layerContents (layerNumRef 18)
			(attr "RefDes" "RefDes" (pt 0.000, 0.095) (textStyleRef "Default") (isVisible True))
		)
		(layerContents (layerNumRef 28)
			(line (pt -1.7 -0.963) (pt 1.7 -0.963) (width 0.1))
		)
		(layerContents (layerNumRef 28)
			(line (pt 1.7 -0.963) (pt 1.7 0.962) (width 0.1))
		)
		(layerContents (layerNumRef 28)
			(line (pt 1.7 0.962) (pt -1.7 0.962) (width 0.1))
		)
		(layerContents (layerNumRef 28)
			(line (pt -1.7 0.962) (pt -1.7 -0.963) (width 0.1))
		)
	...
	(compDef "EVP-ATAL1B000" (originalName "EVP-ATAL1B000") (compHeader (numPins 7) (numParts 1) (refDesPrefix S)
		...
		(compPin "MP3" (pinName "MP3") (partNum 1) (symPinNum 7) (gateEq 0) (pinEq 0) (pinType Bidirectional))
