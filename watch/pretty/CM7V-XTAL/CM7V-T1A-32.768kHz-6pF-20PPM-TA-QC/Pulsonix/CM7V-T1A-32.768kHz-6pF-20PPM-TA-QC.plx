...
(library Library_1
	...
	(symbolDef "CM7V-T1A-32.768kHz-6pF-20PPM-T" (originalName "CM7V-T1A-32.768kHz-6pF-20PPM-T")
	...
	(compDef "CM7V-T1A-32.768kHz-6pF-20PPM-T" (originalName "CM7V-T1A-32.768kHz-6pF-20PPM-T") (compHeader (numPins 2) (numParts 1) (refDesPrefix Y)
		...
		(attachedSymbol (partNum 1) (altType Normal) (symbolName "CM7V-T1A-32.768kHz-6pF-20PPM-T"))
		...
		(attr "<Hyperlink>" "https://www.mouser.de/datasheet/2/530/CM7V_T1A-1957503.pdf")
		(attr "<Component Height>" "0.65")
		(attr "<STEP Filename>" "CM7V-T1A-32.768kHz-6pF-20PPM-TA-QC.stp")
